  ...
  return (
    <footer className="relative bg-gradient-to-br from-stone-50 via-white to-stone-100 overflow-hidden">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 z-50 w-12 h-12 bg-blue-500 text-white rounded-full shadow-lg hover:bg-coral-600 transition-all hover:scale-110 flex items-center justify-center">
      ...
      <div className="relative bg-gradient-to-r from-gray-300 via-gray-100 to-gray-300 text-black/90">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray/80">Exclusive Offers</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold">24h</div>
                  <div className="text-sm text-gray/80">Early Access</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold">Weekly</div>
                  <div className="text-sm text-gray/80">Style Tips</div>
                </div>
              </div>
            </div>

            <div className="relative">
              <div className="bg-gray/10 backdrop-blur-lg rounded-2xl p-8 border border-gray/20">
                <div className="flex gap-3 mb-6">
                  <input
                    ...
                    className="flex-1 px-4 py-3 rounded-xl text-black focus:outline-none focus:ring-2 focus:ring-white/50 placeholder-gray-600 border-2"
                  />
                  <button className="bg-blue-500 text-white px-6 py-3 rounded-xl hover:bg-blue-600 transition-all hover:scale-105 flex items-center gap-2">
                    <span className="hidden sm:inline">Subscribe</span>
                    <ArrowRight className="h-5 w-5" />
                  </button>
                </div>

                <div className="flex items-center gap-4 text-sm text-grey/70">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16">
          ...
          {stats.map((stat, index) => (
            <div key={index} className="text-center group">
              <div className="w-16 h-16 bg-coral-500/10 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-coral-500/20 transition-all group-hover:scale-110">
                <div className="text-coral-500">{stat.icon}</div>
              </div>
        ...
        <div className="border-t border-gray-200 mt-16 pt-12">
            ...
            {[
              ...
              <div key={index} className="group">
                <div className="bg-white rounded-2xl p-6 border border-gray-100 hover:border-coral-200 transition-all hover:shadow-lg group-hover:scale-105">
                  <div
                    className={`w-12 h-12 ${feature.accent} rounded-xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform`}>
                    {feature.icon}
                  </div>
          ...
          <div className="text-center mb-8">
            <h5 className="font-semibold text-black mb-4 text-sm tracking-wide">
              WE ACCEPT
            </h5>
            <div className="flex justify-center flex-wrap gap-3">
              {[
                ...
                <div
                  key={method}
                  className="bg-white border border-gray-200 rounded-lg px-4 py-2 text-xs font-medium text-gray-700 hover:border-coral-300 transition-colors">
                  {method}
                </div>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6 text-sm text-gray-500 font-light">
              <span>&copy; 2025 Mutovu Market Ltd. All rights reserved.</span>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-500">
                ...
                <span className="font-semibold text-black">MUTOVU MARKET</span>
              </div>
            </div>
          </div>
        </div>
