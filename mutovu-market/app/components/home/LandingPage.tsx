          ...
          if (userData?.role) {
            switch (userData.role.toLowerCase()) {
              case 'seller':
                ...
                return;
              case 'deliverer':
                router.push('/pages/deliverer/dashboard');
                return;
              case 'customer':
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {categories.map((category, index) => (
              <div key={category.name} className="group cursor-pointer">
                <div className="relative overflow-hidden bg-gray-50 dark:bg-gray-800 aspect-[4/5] mb-4 group-hover:bg-gray-100 dark:group-hover:bg-gray-700 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-end mb-16">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 font-light">Handpicked essentials</p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {featuredProducts.map((product) => (
              <div key={product.id} className="group cursor-pointer">
                <div className="relative overflow-hidden bg-white dark:bg-gray-700 aspect-[3/4] mb-4 group-hover:shadow-lg transition-all">
                  {product.badge && (
                  ...
                  {/* Product placeholder */}
                  <div className="h-full flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-600 dark:to-gray-700">
                    <div className="text-4xl text-gray-300 dark:text-gray-500">👗</div>
                  </div>
                </div>

                <div className="space-y-2">
                  <h3 className="font-medium text-black dark:text-white group-hover:text-coral-500 transition-colors">
                    {product.name}
                  </h3>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 font-light">60 day policy</p>
            </div>
      ...
      {showUserDropdown && (
        <div
          ...
          onClick={() => setShowUserDropdown(false)}></div>
      )}
